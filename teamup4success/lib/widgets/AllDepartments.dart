                                ...
                                itemBuilder: (ctx, i) {
                                  return ListTile(
                                    ...
                                    IconButton(
                                      ...
                                      color: Colors.red,
                                      onPressed: () {
                                          store.collection('department_list').doc(snapshot.data!.docs[i].get('Abteilung')).delete();
                                          store.collection('subject_list').doc(snapshot.data!.docs[i].get('Abteilung')).delete();
                                      },
                                    ),
